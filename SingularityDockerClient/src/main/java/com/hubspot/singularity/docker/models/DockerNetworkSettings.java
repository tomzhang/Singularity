...
public class DockerNetworkSettings {
  ...
  private DockerNetworkSettings() {
  }

  private DockerNetworkSettings(final Builder builder) {
  ...
  public boolean equals(final Object o) {
    ...
    final DockerNetworkSettings that = (DockerNetworkSettings) o;
  ...
  public static class Builder {
    ...
    private Builder(final DockerNetworkSettings networkSettings) {
    ...
    public DockerNetworkSettings build() {
      return new DockerNetworkSettings(this);
    }
  }
}
