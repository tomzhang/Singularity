...
public class DockerContainerInfo {
  ...
  @JsonProperty("Config") private DockerContainerConfig config;
  @JsonProperty("HostConfig") private DockerHostConfig hostConfig;
  @JsonProperty("State") private DockerContainerState state;
  @JsonProperty("Image") private String image;
  @JsonProperty("NetworkSettings") private DockerNetworkSettings networkSettings;
  ...
  public DockerContainerConfig config() {
    return config;
  }
  ...
  public DockerNetworkSettings networkSettings() {
  ...
  public boolean equals(final Object o) {
    ...
    final DockerContainerInfo that = (DockerContainerInfo) o;
